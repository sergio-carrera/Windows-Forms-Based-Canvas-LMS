...
//using Proyecto_GestionAcademica_Grupo05.Formularios.Login;


namespace Proyecto_GestionAcademica_Grupo05
{
    public partial class MenuPrincipalEstudiante : Form
    {
        ...
        public MenuPrincipalEstudiante(string id)
        {
            InitializeComponent();
        ...
        public void AbrirFormHijo(Form formHijo)
        {
            try
            {
                ...
                panelDesktop.Controls.Add(formHijoActual);
        ...
        public void AbrirFormHijo2(Form formHijo)
        {
            try
            {
                ...
                formHijo.FormBorderStyle = FormBorderStyle.None;
                formHijo.Dock = DockStyle.Fill;
                panelDesktop2.Controls.Add(formHijoActual2);
                panelDesktop2.Tag = formHijo;
                panelDesktop2.Visible = true;
                formHijo.BringToFront();
                formHijo.Show();
            }
            catch (Exception ex)
        ...
        {
            ActivarBoton(sender);
            AbrirFormHijo2(new Cuenta1(idCred));
        }
        ...
        {
            ActivarBoton(sender);
            AbrirFormHijo2(new Cursos1(idCred));
        }
