...
{
    public partial class seleccionarfotop : Form
    {
        private Cuenta2_profesor formHijo1;
        private editarperfilhijop formHijo2;
        private string idCred;
        public Image ImagenSeleccionada { get; private set; }

        public seleccionarfotop(Cuenta2_profesor padre, string idCred)
        {
            InitializeComponent();
            formHijo1 = padre;
            this.idCred = idCred;
